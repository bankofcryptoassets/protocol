...
exports.LoanSummary = async (req, res) => {
  ...
  liquidationPricesArray.push(
    Number.parseFloat(initialLiquidationPrice.toFixed(2)),
  );
  ...
  for (let month = 1; month <= loanTerm; month++) {
    ...
    liquidationPricesArray.push(Number.parseFloat(liquidationPrice.toFixed(2)));
